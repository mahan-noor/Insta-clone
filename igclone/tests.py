...
class FollowTestClass(TestCase):
    def setUp(self):
        self.lorna = User(username = "lorna", email = "lorna@gmail.com",password = "1234")
        self.profile1 = Profile(bio='bio', user= self.lorna)        
        self.ciru = User(username = "ciru", email = "ciru@gmail.com",password = "1234")
        self.profile2 = Profile(bio='bio', user= self.ciru) 
        self.lorna.save()
        self.ciru.save()
